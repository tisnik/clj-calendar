;
;  (C) Copyright 2015, 2016, 2017, 2020  Pavel Tisnovsky
;
...
(deftest test-get-calendar-existence
  ...
  (testing
    "if the clj-calendar.calendar/get-calendar function definition exists."
...
(deftest test-get-calendar-for-week-existence
  ...
  (testing
    "if the clj-calendar.calendar/get-calendar-for-week function definition exists."
...
(deftest test-get-day-of-week-existence
  ...
  (testing
    "if the clj-calendar.calendar/get-day-of-week function definition exists."
...
(deftest test-format-date-existence
  ...
  (testing
    "if the clj-calendar.calendar/format-date function definition exists."
...
(deftest test-format-date-time-existence
  ...
  (testing
    "if the clj-calendar.calendar/format-date-time function definition exists."
...
(deftest test-format-date-using-desired-format-existence
  ...
  (testing
    "if the clj-calendar.calendar/format-date-using-desired-format function definition exists."
...
(deftest test-format-from-to-date-for-week-existence
  ...
  (testing
    "if the clj-calendar.calendar/format-from-to-date-for-week function definition exists."
...
(deftest test-calculate-first-day-of-week-existence
  ...
  (testing
    "if the clj-calendar.calendar/calculate-first-day-of-week function definition exists."
...
(deftest test-get-first-day-of-week-existence
  ...
  (testing
    "if the clj-calendar.calendar/get-first-day-of-week function definition exists."
...
(deftest test-get-last-day-of-week-existence
  ...
  (testing
    "if the clj-calendar.calendar/get-last-day-of-week function definition exists."
...
(deftest test-get-first-day-of-week-formatted-existence
  ...
  (testing
    "if the clj-calendar.calendar/get-first-day-of-week-formatted function definition exists."
...
(deftest test-get-last-day-of-week-formatted-existence
  ...
  (testing
    "if the clj-calendar.calendar/get-last-day-of-week-formatted function definition exists."
...
(deftest test-get-calendar
  ...
  (testing
    "the function clj-calendar.calendar/get-calendar."
    (is (not (nil? (get-calendar))))
    (is (or (= (class (get-calendar)) java.util.Calendar)
            (= (class (get-calendar)) java.util.GregorianCalendar)))
    (is (or (= (type  (get-calendar)) java.util.Calendar)
            (= (type  (get-calendar)) java.util.GregorianCalendar)))
    (is (== (.get (get-calendar) (java.util.Calendar/ERA))
...
(deftest test-get-calendar-2
  ...
  (testing "the function clj-calendar.calendar/get-calendar."
           (let [calendar (get-calendar)]
             ...
             (is (not (nil? calendar)))
             (is (or (= (class calendar) java.util.Calendar)
                     (= (class calendar) java.util.GregorianCalendar)))
             (is (or (= (type  calendar) java.util.Calendar)
...
(deftest test-get-calendar-6
  "Check the function clj-calendar.calendar/get-calendar."
  (testing "the function clj-calendar.calendar/get-calendar."
           (let [calendar (get-calendar)]
             (.set calendar 0 01 01 10 20 30)
             (is (= (.get calendar (java.util.Calendar/HOUR)) 10))
             (is (= (.get calendar (java.util.Calendar/MINUTE)) 20))
             (is (= (.get calendar (java.util.Calendar/SECOND)) 30)))))

(deftest test-get-calendar-7
  "Check the function clj-calendar.calendar/get-calendar."
  (testing "the function clj-calendar.calendar/get-calendar."
           (let [calendar (get-calendar)]
             (.set calendar 0 01 01 10 20 30)
...
(deftest test-format-date-using-desired-format
  ...
  (testing
    "the function clj-calendar.calendar/format-date-using-desired-format."
    (let [calendar (get-calendar)]
      (.set calendar 2000 01 01 10 20 30)
...
(deftest test-format-date-using-desired-format-5
  ...
  (testing
    "the function clj-calendar.calendar/format-date-using-desired-format."
    (let [calendar (get-calendar)]
      (.set calendar 1000 01 01 10 20 30)
      (is (= "1000" (format-date-using-desired-format calendar "yyyy")))
      (is (= "00"   (format-date-using-desired-format calendar "yy")))
      (is (= "02"   (format-date-using-desired-format calendar "MM")))
      (is (= "01"   (format-date-using-desired-format calendar "dd")))
      (is (= "032"  (format-date-using-desired-format calendar "DDD")))   ; day in year
  ...
  (testing "the function clj-calendar.calendar/calculate-first-day-of-week"
           (doseq [year (range 2000 2010)]
             (doseq [week (range 1 52)]
               ...
               (is (zero? (calculate-first-day-of-week
                            (get-calendar-for-week year week))))))))

(deftest test-calculate-first-day-of-week-2
  "Check the function clj-calendar.calendar/calculate-first-day-of-week"
  (testing
    "the function clj-calendar.calendar/calculate-first-day-of-week"
    (let [calendar (get-calendar)]
      (doseq [day (range 1 365)]
...
(deftest test-format-from-to-date-for-week-1
  ...
  (testing
    "the function clj-calendar.calendar/format-from-to-date-for-week"
...
(deftest test-format-current-date
  ...
  (testing "the function clj-calendar.calendar/format-current-date"
           (is (re-matches #"[0-9]{4}-[0-9]{2}-[0-9]{2}"
                           (format-current-date)))))
